...
<template>
  ...
  <div class="flex flex-wrap gap-2 mt-4">
    <div @click="router.push('/admin/new-session')" class="h-40 cursor-pointer w-full lg:w-74 flex-col border-dashed border-2 rounded-2xl flex items-center justify-center"><p class="text-6xl">+</p><p class="text-xl">NEUE SESSION</p></div>
